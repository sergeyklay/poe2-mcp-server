...
Args:
  - term (string): English name of an item, gem, mod, etc. Use underscores for spaces, e.g. "Essence_Drain", "Chaos_Bolt"
  - lang ("us" | "ru"): Language — "us" for English (default), "ru" for Russian
  ...
  - Unique item: term="Atziri's_Rule"`,
      inputSchema: {
        term: z
          .string()
          .min(1)
          .describe('Search term with underscores for spaces, e.g. "Essence_Drain"'),
      ...
      try {
        ...
        return {
          ...
          content: [
            {
              type: 'text',
              text: `Error looking up "${term}" on poe2db: ${msg}\n\nTip: Use English names with underscores, e.g. "Essence_Drain", "Orb_of_Augmentation"`,
            },
          ],
        };
      }
